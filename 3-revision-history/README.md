...
Navigate the repository to find a specific commit
?? Challenge
#	Challenge	Solution	Duration	What you will learn	More information
1	Find the hidden message in Commit ID ##### 	Link	3 min	How to filter in the Git Repository window	
...
•	Revert changes | Microsoft Learn
•	Copy commits (cherry-pick) | Microsoft Learn
