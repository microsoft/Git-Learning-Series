...
*	Week 2 – Cloning a repository from GitHub 
*	Week 3 – Exploring a Git repository using Visual Studio
*	Week 4 – Adding your existing code to Git and GitHub 
*	Week 5 – Connecting GitHub to your daily workflow 
*	Week 6 – Next Steps
