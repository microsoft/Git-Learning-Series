...
![Create a Git repository Window](images/create-a-git-repository-window.png)![Sign in to GitHub](images/sign-in-to-github.png)
...
![Create a Git repository Window - Signed in](images/create-a-git-repository-window-signed-in.png)
